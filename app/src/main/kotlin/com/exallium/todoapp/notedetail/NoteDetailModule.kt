...
class NoteDetailModule(private val noteDetailView: NoteDetailView) {
    ...
    @Provides
    @PerScreen
    fun providePresenter(model: NoteDetailModel, screenBundleHelper: ScreenBundleHelper, bundleFactory: BundleFactory): NoteDetailPresenter
            = NoteDetailPresenter(noteDetailView, model, screenBundleHelper, bundleFactory)
}